...
const ModuleForm = ({ params }: any) => {
    ...
    const [is_a_provider_selected, setProvider] = useState<any>(false)
    ...
    const [correlativeCode, setCorrelativeCode] = useState<string>("")
    ...
    const getData = async () => {
        ...
        if (id) {
            ...
            if (get) {
                ...
                setCorrelativeCode(get.correlativeCode)
    ...
    const onFinish: FormProps<FieldType>['onFinish'] = async (values) => {
        try {
            ...
            console.log("LA RESPUESTA DEL BACKENDDDDDDD", res);

            if (res) { toast.error(res.message); setLoader(false); return }
                        ...
                        <Row gutter={32}>
                            ...
                            <Col span={24} md={8}>
                                ...
                                >
                                    ...
                                    <Select
                                        ...
                                        disabled={is_a_provider_selected}
                                    />
                                </Form.Item>
                            </Col>
                            ...
                            <Col span={24} md={12}>
                                <Form.Item<FieldType>
                                    ...
                                    rules={[{ required: true }]}
                                >
                                    <Input disabled={is_a_provider_selected} />
                                </Form.Item>
                            </Col>
