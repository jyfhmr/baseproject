            ...
            <Card bordered={false} style={{ backgroundColor: '#f7f7f7', padding: '8px' }}>
                <Row gutter={[8, 8]} style={{ marginBottom: '4px' }}>
                    <Col span={24}>
                        ...
                        <SeparatorOfData title1={"Código del Correlativo"} title2={paymentInfo.correlativeCode} />
                        ...
                        {paymentInfo.emailEmisor
                            && (
                                <SeparatorOfData title1={"Email del Receptor"} title2={paymentInfo.emailReceptor
                                } />
                            )}
