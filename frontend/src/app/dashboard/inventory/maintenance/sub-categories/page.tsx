...
const page = async ({ searchParams }: any) => {
    ...
    const columns = [
        ...
        { title: 'Codígo', index: 'code', width: 200 },
        ...
        { title: 'Sub Categoria', index: 'name', width: 200 },
    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <ButtonForm module="sub-categories" description={'Nueva Sub categoria'} />
                <div
                    style={{
                        display: 'flex',
