...
const moduleName = 'inventory/maintenance/categories';
...
const page = async ({ searchParams }: any) => {
    ...
    const columns = [
        ...
        { title: 'Estatus', index: 'isActive', fixed: 'right', width: 100 },
        {
            title: 'Acciones',
            index: 'actions',
            width: 100,
    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <ButtonForm module="categories" description={'Nueva categoria'} />
                <div
                    style={{
                        display: 'flex',
