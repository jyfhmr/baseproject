...
const moduleName = 'inventory/maintenance/types-packaging';
...
const page = async ({ searchParams }: any) => {
    ...
    const pageName = 'Tipos de empaques';
    ...
    const columns = [
        ...
        { title: 'Tipo de Empaque', index: 'name', width: 200 },
    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <ButtonForm module="types-packaging" description={'Nuevo Tipo de empaque'} />
                <div
                    style={{
                        display: 'flex',
