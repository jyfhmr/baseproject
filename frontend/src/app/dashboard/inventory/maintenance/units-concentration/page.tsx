...
const moduleName = 'inventory/maintenance/units-concentration';
...
const page = async ({ searchParams }: any) => {
    ...
    const pageName = 'Unidades de Concentración';
    ...
    const columns = [
        ...
        { title: 'Unidad de concentración', index: 'name', width: 200 },
    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <ButtonForm
                    module="units-concentration"
                    description={'Nuevo Unidad de concentración'}
                />
                <div
                    style={{
                        display: 'flex',
