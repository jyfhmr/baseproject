...
const ModuleForm = ({ params }: any) => {
    ...
    const pageName = `${id ? 'Editar' : 'Nuevo'} Unidad de concentracion`;
    ...
    const onFinish: FormProps<FieldType>['onFinish'] = async (values) => {
        ...
        toast.success(`Tipo de presentación ${id ? 'editado' : 'creado'} con éxito`);
    };
                ...
                <Col span={24}>
                    ...
                    >
                        ...
                        <ButtonSubmit loader={loader}>
                            {!id ? 'Guardar' : 'Editar'} Unidad de presentación
                        </ButtonSubmit>
                    </Form>
                </Col>
            </Row>
