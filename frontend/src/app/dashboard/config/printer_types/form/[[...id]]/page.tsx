...
const ModuleForm = ({ params }: any) => {
    ...
    const pageName = `${id ? 'Editar' : 'Nuevo'} Tipo de Impresora`;
    const iconPage = <AppstoreOutlined />;
    const breadCrumb = [
        { title: 'Configuración' },
        { title: 'Tipo de Impresoras' },
        ,
        { title: pageName },
    ];
    ...
    const onFinish: FormProps<FieldType>['onFinish'] = async (values) => {
        ...
        toast.success(
            `Tipo de impresora ${id ? 'editado' : 'creado'} con éxito`,
        );
    };
                ...
                <Col span={24}>
                    ...
                    >
                        ...
                        <ButtonSubmit loader={loader}>
                            {!id ? 'Guardar' : 'Editar'} Tipo de Impresora
                        </ButtonSubmit>
                    </Form>
                </Col>
            </Row>
