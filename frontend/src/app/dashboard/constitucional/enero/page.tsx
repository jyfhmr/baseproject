...
const JanuaryPage: React.FC = () => {
  const januaryData = salasData.Constitucional.Enero; // Accede a los datos de febrero directamente

  // Formatear los datos para la tabla
  const data = januaryData.flatMap(day => 
