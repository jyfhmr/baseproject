...
const FebruaryPage: React.FC = () => {
  const februaryData = salasData.Constitucional.Febrero; // Accede a los datos de febrero directamente

  // Formatear los datos para la tabla
  const data = februaryData.flatMap(day => 
