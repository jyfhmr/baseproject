...
const moduleName = 'masters/client_types';
...
const ModuleForm = ({ params }: any) => {
    ...
    const pageName = `${id ? 'Editar' : 'Nuevo'} Tipo de Cliente`;
    ...
    const onFinish: FormProps<FieldType>['onFinish'] = async (values) => {
        ...
        toast.success(`Tipo de Cliente ${id ? 'editado' : 'creado'} con éxito`);
    };
                ...
                <Col span={24}>
                    ...
                    >
                        ...
                        <ButtonSubmit loader={loader}>
                            {!id ? 'Guardar' : 'Editar'} Tipo de Cliente
                        </ButtonSubmit>
                    </Form>
                </Col>
            </Row>
