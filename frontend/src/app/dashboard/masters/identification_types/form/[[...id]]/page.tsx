...
const moduleName = 'masters/identification_types';
...
const ModuleForm = ({ params }: any) => {
    ...
    const pageName = `${id ? 'Editar' : 'Nuevo'} Tipo de Identificación`;
    ...
    const onFinish: FormProps<FieldType>['onFinish'] = async (values) => {
        ...
        toast.success(`Tipo de Identificación ${id ? 'editado' : 'creado'} con éxito`);
    };
                ...
                <Col span={24}>
                    ...
                    >
                        ...
                        <ButtonSubmit loader={loader}>
                            {!id ? 'Guardar' : 'Editar'} Tipo de Identificación
                        </ButtonSubmit>
                    </Form>
                </Col>
            </Row>
