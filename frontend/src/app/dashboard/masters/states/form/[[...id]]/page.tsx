...
const moduleName = 'masters/states';
...
const ModuleForm = ({ params }: any) => {
    ...
    const pageName = `${id ? 'Editar' : 'Nuevo'} Estado`;
    const iconPage = <AppstoreOutlined />;
    const breadCrumb = [{ title: 'Maestros' }, { title: 'Estados' }, , { title: pageName }];
    ...
    const onFinish: FormProps<FieldType>['onFinish'] = async (values) => {
        ...
        toast.success(`Estado ${id ? 'editado' : 'creado'} con éxito`);
    };
