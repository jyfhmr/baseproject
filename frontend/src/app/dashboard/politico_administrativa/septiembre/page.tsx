...
const SeptemberPage: React.FC = () => {
  const septemberData = salasData['Político Administrativa'].Septiembre; // Accede a los datos de febrero directamente

  // Formatear los datos para la tabla
  const data = septemberData.flatMap(day => 
  ...
  return (
    <div>
      <h1>Sentencias de Septiembre</h1>
