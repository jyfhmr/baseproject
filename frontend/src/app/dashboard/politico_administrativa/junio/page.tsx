...
const JunePage: React.FC = () => {
  const juneData = salasData['Político Administrativa'].Junio; // Accede a los datos de febrero directamente

  // Formatear los datos para la tabla
  const data = juneData.flatMap(day => 
