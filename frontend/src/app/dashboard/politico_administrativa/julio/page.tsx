...
const JulyPage: React.FC = () => {
  const julyData = salasData['Político Administrativa'].Julio; // Accede a los datos de febrero directamente

  // Formatear los datos para la tabla
  const data = julyData.flatMap(day => 
