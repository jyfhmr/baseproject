...
import { TaxUnitsRate } from 'src/modules/config/administrative/tax_units_rate/entities/tax_units_rate.entity';
import { Rates2Range } from 'src/modules/config/administrative/rates2_ranges/entities/rates2_range.entity';
...
export class AdministrativeConfigsSeeder1722608900000 implements Seeder {
    ...
    private async seedPaymentConcepts(dataSource: DataSource) {
        ...
        const paymentConceptsData = [
            ...
            {
                name: 'PAGO POR ENAJENACION DE BIENES DE FONDOS DE COMERCIO',
                numeroLiteral: '9.18',
                isActive: true,
                user: { id: 1 },
                userUpdate: { id: 1 },
            ...
            {
                name: 'PAGO A PROVEEDORES EMISORAS DE RADIO',
                numeroLiteral: '9.19',
                isActive: true,
                user: { id: 1 },
                userUpdate: { id: 1 },
            ...
            {
                name: 'PROCEDIMIENTOS POR ENAJENACION DE ACCIONES FUERA DE LA BOLSA DE VALORES',
                numeroLiteral: '9.21',
                isActive: true,
                user: { id: 1 },
                userUpdate: { id: 1 },
