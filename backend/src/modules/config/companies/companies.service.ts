...
export class CompaniesService {
    ...
    async create(
        ...
        console.log("dto trasnformado",transformedDto)
        ...
        const newCompany = {
            ...
            rifLegalRepresentativeFile: files.rifLegalRepresentativeFile ? files.rifLegalRepresentativeFile[0].filename : undefined,
        };
